 ...
 * @version $Id: freehep-graphicsio/src/main/java/org/freehep/graphicsio/font/FontEmbedderType1.java 5641ca92a537 2005/11/26 00:15:35 duns $
 */
public class FontEmbedderType1 extends FontEmbedder {
    ...
    protected void openIncludeFont() throws IOException {
        ...
        // format(new Date()));
        fontFile.println("% Generated by: " + "FreeHEP VectorGraphics");
        fontFile.println("11 dict begin");

        fontFile.println("/FontInfo 8 dict dup begin");
        fontFile.println("/FullName (" + getFontPSName() + ") readonly def");
    ...
    protected void closeIncludeFont() {
        ...
        int lly = -(int) Math.round(boundingBox.getY() + boundingBox.getHeight());
        int urx = (int) Math.round(boundingBox.getX() + boundingBox.getWidth());
        int ury = -(int) Math.round(boundingBox.getY());
...
//        double sidebearing = glyphMetrics != null ? glyphMetrics.getLSB() : 0;
        ...
        // Value 0 seems to be right - Levantovsky
